...
if __name__ == '__main__':    
    ...
    n_classes = 12
    saved_models = [
        ['/home/iris/weights_and_configs/SS3.json',
         '/home/iris/weights_and_configs/conv_temporal_SS3_MMSE_SS3_agc_swa80_2_v_0/'
         'SWA_best_0.34428465366363525.hdf5'],
        ['/home/iris/weights_and_configs/SS5.json',
         '/home/iris/weights_and_configs/conv_temporal_SS5_MMSE_SS5_agc_smt01_mask_v_0/'
         'SWA_best_0.34466397762298584.hdf5'],
        ['/home/iris/weights_and_configs/SS5.json',
         '/home/iris/weights_and_configs/conv_temporal_SS5_MSE_SS5_smt01_l21e-4_v_0/'
    ...
    for i, preds in tqdm(enumerate(outputs)):
        answer_class = preds[0] > [0.3, 0.45, 0.45, 0.5, 0.7, 0.6, 0.5, 0.5, 0.5, 0.5, 0.6, 0.7]
