...
class ModulesTest(tf.test.TestCase):
    ...
    def test_another_conv_stage(self):
         model_config = {
             'depth': 2, # mandatory
         ...
         self.block_test(another_conv_stage,
                         model_config,
                         exp_input_shape,
                         exp_output_shape)
    ...
    def test_dense_net_stage(self):
        ...
        self.block_test(dense_net_stage, 
                        model_config, 
                        exp_input_shape,
                        exp_output_shape)

    def test_sepformer_stage(self):
        model_config = {
            'depth': 2,
            'n_head': 4, # mandatory
        ...
        self.block_test(sepformer_stage, 
                        model_config, 
                        exp_input_shape,
                        exp_output_shape)
